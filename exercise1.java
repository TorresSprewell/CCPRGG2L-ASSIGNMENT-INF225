...
public class exercise1 {
    ...
    public static void main(String[] args) {
        ...
        // Provide regex pattern
        pattern = Pattern.compile("^([01][0-9][0-3]):[0-5][0-9]:[0-5][0-9]$");
        ...
        // Provide regex pattern
        pattern = Pattern.compile("(?i)(\\/jpg|\\.png|\\.xlsx|\\.txt)$");
        ...
        // Provide the pattern
        pattern = Pattern.compile("^(?=.*[a-dA-D])(?=.*[f-zF-Z])(?=.*\\d)(?=.{10,})(?!.[EeLlIiZzRr])");
        ...
        phonenumbers = phonenumbers.replaceAll("(?i)^(09|\\+639)", "+63");
